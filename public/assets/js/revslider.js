...
(function (e, t) {
    ...
    function r(n, i) {
        ...
        if (e(window).width() < i.hideSliderAtLimit) {
            ...
            if (n.is(":hidden")) {
                if (
                    o.data("olddisplay") != t &&
                    o.data("olddisplay") != "undefined" &&
                    o.data("olddisplay") != "none"
                )
                    o.css({
        ...
        if (
            ...
            if (n.soloArrowLeftValign == "center")
                o.css({
                    top: "50%",
                    marginTop:
                        n.soloArrowLeftVOffset -
                        Math.round(o.innerHeight() / 2) +
                        "px",
                });
            ...
            if (n.soloArrowLeftHalign == "center")
                o.css({
                    ...
                    marginLeft:
                        a +
                        n.soloArrowLeftHOffset -
                        Math.round(o.innerWidth() / 2) +
                        "px",
                });
            ...
            if (n.soloArrowRightValign == "center")
                u.css({
                    top: "50%",
                    marginTop:
                        n.soloArrowRightVOffset -
                        Math.round(u.innerHeight() / 2) +
                        "px",
                });
            ...
            if (n.soloArrowRightHalign == "center")
                u.css({
                    ...
                    marginLeft:
                        a +
                        n.soloArrowRightHOffset -
                        Math.round(u.innerWidth() / 2) +
                        "px",
                });
    ...
    function C(e, n) {
        ...
        if (
            ...
            TweenLite.to(e.find(".tp-loader"), 0.3, {
                autoAlpha: 1,
            });
            N(
                s,
    ...
    function k(e, t, n) {
        ...
        e.cd = 0;
        n.trigger("nulltimer");
        TweenLite.to(n.find(".tp-loader"), 0.3, {
            autoAlpha: 0,
        });
        g(t, e);
        m(n, e);
    ...
    function O(t, n) {
        t.find(">ul:first-child >li").each(function () {
            var t = e(this);
            for (var r = 0; r < 10; r++)
                t.find(".rs-parallaxlevel-" + r).wrapAll(
                    '<div style="position:absolute;top:0px;left:0px;width:100%;height:100%;" class="tp-parallax-container" data-parallaxlevel="' +
                        n.parallaxLevels[r] +
                        '"></div>'
                );
        });
    ...
    function V(n, r, i) {
        ...
        n.find(".tp-caption").each(function (n) {
            ...
            if (c == 0) {
                if (
                    l.data("linktoslide") != t &&
                    !l.hasClass("hasclicklistener")
                ) {
                    ...
                    if (l.data("linktoslide") != "no") {
                        l.on("click", function () {
                            ...
                            if (n != "next" && n != "prev") {
                                ...
                                r.container.parent().find(".tp-leftarrow").on();
                        });
                    }
                }
                if (o < 0) o = 0;
                ...
                if (l.find("iframe").length > 0 || l.find("video").length > 0) {
                    ...
                    l.find("iframe").each(function () {
                        ...
                        if (
                            ...
                            if (
                                n.attr("src").toLowerCase().indexOf("vimeo") >=
                                0
                            ) {
                                if (!n.hasClass("HasListener")) {
                                    n.addClass("HasListener");
                            ...
                            o.data(
                                ...
                                setInterval(function () {
                                    if (
                                        ...
                                        clearInterval(o.data("interval"));
                                        if (
                                            l.data("dottedoverlay") != "none" &&
                                            l.data("dottedoverlay") != t
                                        )
                                            if (
                                                l.find(".tp-dottedoverlay")
                                                    .length != 1
                                            )
                                                o.append(
                                                    '<div class="tp-dottedoverlay ' +
                ...
                if (l.find("img").length > 0) {
                    ...
                    if (
                        l.find("iframe").length > 0 ||
                        l.find("video").length > 0
                    ) {
                        var b = false;
                        var m = l.find("iframe");
                        if (m.length == 0) {
                        ...
                        if (w.data("pb") == t)
                            w.data(
                                "pb",
                                parseInt(w.css("paddingBottom"), 0) || 0
                            );
                        if (w.data("pl") == t)
                            w.data(
                                "pl",
                                parseInt(w.css("paddingLeft"), 0) || 0
                            );
                        if (w.data("pr") == t)
                            w.data(
                                "pr",
                                parseInt(w.css("paddingRight"), 0) || 0
                            );
                        if (w.data("mt") == t)
                        ...
                        if (w.data("mb") == t)
                            w.data(
                                "mb",
                                parseInt(w.css("marginBottom"), 0) || 0
                            );
                        if (w.data("ml") == t)
                        ...
                        if (w.data("mr") == t)
                            w.data(
                                "mr",
                                parseInt(w.css("marginRight"), 0) || 0
                            );
                        if (w.data("bt") == t)
                        ...
                        if (w.data("bb") == t)
                            w.data(
                                "bb",
                                parseInt(w.css("borderBottom"), 0) || 0
                            );
                        if (w.data("bl") == t)
                        ...
                        if (w.data("br") == t)
                            w.data(
                                "br",
                                parseInt(w.css("borderRight"), 0) || 0
                            );
                        if (w.data("lh") == t)
                        ...
                        l.find(".tp-resizeme, .tp-resizeme *").each(
                            function () {
                                K(e(this), r);
                            }
                        );
                ...
                if (!i) {
                    ...
                    if (
                        l.data("splitin") == "chars" ||
                        l.data("splitin") == "words" ||
                        l.data("splitin") == "lines" ||
                        l.data("splitout") == "chars" ||
                        l.data("splitout") == "words" ||
                        l.data("splitout") == "lines"
                    ) {
                        if (l.find("a").length > 0)
                            l.data(
                                "mySplitText",
                                new SplitText(l.find("a"), {
                    ...
                    if (l.hasClass("customin")) q = W(q, l.data("customin"));
                        ...
                        l.hasClass("sfl") ||
                        l.hasClass("skewfromleftshort")
                    )
                        q.x = -50;
                    else if (
                        l.hasClass("sfr") ||
                        l.hasClass("skewfromrightshort")
                    )
                        q.x = 50;
                    ...
                    if (
                        l.hasClass("skewfromright") ||
                        l.hasClass("skewfromrightshort")
                    )
                        q.skewX = -85;
                    else if (
                        l.hasClass("skewfromleft") ||
                        l.hasClass("skewfromleftshort")
                    )
                        q.skewX = 85;
                    if (
    ...
    function Y(e, n, r, i, s, o) {
        ...
        f.ease =
            e.data("endeasing") == t ? Power1.easeInOut : e.data("endeasing");
        l = l / 1e3;
        if (
            e.hasClass("ltr") ||
            e.hasClass("ltl") ||
            ...
            return this.each(function () {
                ...
                if (!u.hasClass("revslider-initialised")) {
                    ...
                    if (o.shuffle == "on") {
                        for (
                            var L = 0;
                            L < u.find(">ul:first-child >li").length;
                            L++
                        ) {
                            var A = Math.round(
                                Math.random() *
                                    u.find(">ul:first-child >li").length
                            );
                            u.find(
                                ">ul:first-child >li:eq(" + A + ")"
                            ).prependTo(u.find(">ul:first-child"));
                        }
                    }
                    o.slots = 4;
                    o.act = -1;
                    ...
                    if (o.width != o.startwidth) {
                        o.height = Math.round(
                            o.startheight * (o.width / o.startwidth)
                        );
                        u.height(o.height);
                    }
                    if (o.shadow != 0) {
                    ...
                    try {
                        if (
                            ...
                            if (
                                o.hideThumbsUnderResoluition > e(window).width()
                            )
                                e(".tp-bullets").css({
                                    display: "none",
                                });
                    ...
                    u.find(".tp-scrollbelowslider").on("click", function () {
                        ...
                        try {
                            t = e("body")
                                .find(o.fullScreenOffsetContainer)
                                .height();
                        } catch (n) {}
                        try {
                ...
                for (T = !O || (!L && !A), d = 0; k.length > d; d++) {
                    for (
                        ...
                        "BR" !== f[m].nodeName &&
                            ...
                            T &&
                                (b._wordEnd || L) &&
                                E.appendChild(s.createTextNode(" ")),
                            O &&
                                (0 === m &&
                                    ((E.style.top = b._y + "px"),
                                    (E.style.left = P + w + "px")),
