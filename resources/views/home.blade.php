...
@section('content')   
              ...
              <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                <ul>
                  <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                    data-thumb='{{asset('assets/images/slide-img1.jpg')}}'>
                    <img src='{{asset('assets/images/slide-img1.jpg')}}' data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner" />
                    <div class="container">
                          ...
                          <div class="col-lg-9 col-sm-9 col-md-9">
                            <div class="info">
                              <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500'
                                ...
                                style='z-index:2; white-space:nowrap;'><span>Digital World</span> </div>
                              <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500' data-speed='500'
                                ...
                                style='z-index:3; white-space:nowrap;'><span
                                  style="font-weight:normal; display:block">Smartphone</span> INCREDIBLE </div>
                  ...
                  <li data-transition='random' data-slotamount='7' data-masterspeed='1000'
                    data-thumb="{{asset('assets/images/slide-img2.jpg')}}"><img src="{{asset('assets/images/slide-img2.jpg')}}" data-bgfit='cover'
                          ...
                          <div class="col-lg-9 col-sm-9 col-md-9">
                            <div class="info">
                              <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500'
                                data-speed='500' data-start='1100' data-easing='Linear.easeNone' data-splitin='none'
                                data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1'
                                style='z-index:2; white-space:nowrap;'><span>Top Brands 2021</span> </div>
                              <div class='tp-caption LargeTitle sfl  tp-resizeme ' data-endspeed='500' data-speed='500'
                                data-start='1300' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                data-elementdelay='0.1' data-endelementdelay='0.1'
                                style='z-index:3; white-space:nowrap;'><span
                                  style="font-weight:normal; display:block">Smartwatch</span> Perfection </div>
                              <div class='tp-caption sfb  tp-resizeme ' data-endspeed='500' data-speed='500'
                                data-start='1500' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none'
                                data-elementdelay='0.1' data-endelementdelay='0.1'
                                style='z-index:4; white-space:nowrap;'><a href='#' class="buy-btn">Shop Now</a> </div>
    ...
    <div id="product-tabs-slider" class="scroll-tabs">
      <div class="more-info-tab clearfix">
        <ul class="nav nav-tabs nav-tab-line container">
          <li class="active"> <a data-transition-type="backSlide" href="#mobiles" data-toggle="tab"> <img
                src="{{asset('assets\images\mobile-img.jpg')}}" alt="mobiles"> <span> Mobiles</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#television" data-toggle="tab"> <img src="{{asset('assets\images\tv-img.jpg')}}"
                alt="Television"> <span>Television</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#camera" data-toggle="tab"> <img src="{{asset('assets\images\camera-img.jpg')}}"
                alt="camera"> <span>Cameras</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#speakers" data-toggle="tab"> <img src="{{asset('assets\images\speakers.jpg')}}"
                alt="Speakers"> <span>Speakers</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#laptop" data-toggle="tab"> <img src="{{asset('assets\images\laptop.jpg')}}"
                alt="laptop"> <span>Laptops</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#watches" data-toggle="tab"> <img src="{{asset('assets\images\watchs.jpg')}}"
                alt="Watches"> <span>Watches</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#refrigerator" data-toggle="tab"> <img
                src="{{asset('assets\images\refrigerator.jpg')}}" alt="refrigerator"> <span>Refrigerator</span> </a> </li>
          <li> <a data-transition-type="backSlide" href="#mixer" data-toggle="tab"> <img src="{{asset('assets\images\mixer.jpg')}}"
                alt="mixer"> <span> Mixer</span> </a> </li>
        </ul>
        <!-- /.nav-tabs -->
      </div>

      <div class="tab-content container">
        <div class="tab-pane active" id="mobiles">
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                ...
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product1.jpg')}}"> </a>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Anti Glare Side Narrow Border Display
                          Laptop</a> </div>
                      ...
                      <div class="item-content">
                        <div class="item-price">
                          <div class="price-box"> <span class="regular-price"> <span class="price">AED 129.00</span>
                            </span> </div>
                        </div>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product2.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview openModal"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html"> Point and Shoot Camera with 12x Optical
                          Zoom </a> </div>
                      ...
                      <div class="item-content">
                        <div class="item-price">
                          <div class="price-box"><span class="regular-price"><span class="old-price"><span
                                  class="price">AED 199.00</span></span> <span class="price">AED 88.00</span>
                            </span> </div>
                        </div>
                        <span style="font-size: 12px
                        ;">Free Shipping & Free Delivery</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product3.jpg')}}"> </a>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Siomons Galaxy N31 Ocean Blue, 8GB RAM,
                          128GB Storag</a> </div>
                      ...
                      <div class="item-content">
                        <div class="item-price">
                          <div class="price-box"> <span class="regular-price"> <span class="price">AED 275.00</span>
                            </span> </div>
                        </div>
                        <span style="font-size: 12px
                        ;">Free Shipping & Free Delivery</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product4.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview openModal"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">NoePlus 4K Ultra HD Android Smart LED
                          Television </a> </div>
                      ...
                      <div class="item-content">
                        <div class="item-price">
                          <div class="price-box"> <span class="regular-price"> <span class="price">AED 88.00</span>
                            </span> </div>
                        </div>
                        <span style="font-size: 12px
                        ;">Free Shipping & Free Delivery</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product5.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview openModal"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html"> Wireless Headphone with Ergonomic
                          Aesthetics </a> </div>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product6.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Health & Fitness Smartwatch with Heart Rate
                          Monitor</a> </div>
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product13.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html"> Health & Fitness Smartwatch with Heart
                          Rate Monitor </a> </div>
                      <div class="brand">Xperia</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product8.jpg')}}"> </a>
                      <div class="new-label new-top-left">new</div>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">750 Watt Mixer Grinder with 3 Stainless
                          Steel Jar</a> </div>
                      <div class="brand">Sunproto</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product10.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Smart Home Security Camera with Intruder
                          Alarm System</a> </div>
                      <div class="brand">Organtic</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product14.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Portable Smart Speaker with built-in WiFi,
                          Bluetooth</a> </div>
                      <div class="brand">Datsun</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product9.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html"> Multi-Function Direct Wireless Network
                          Laser Printer </a> </div>
                      <div class="brand">Xperia</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product11.jpg')}}"> </a>
                      <div class="new-label new-top-left">new</div>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">Stovekraft plastic Induction Stove with
                          Feather touch</a> </div>
                      <div class="brand">Sunproto</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product7.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      <div class="item-title"> <a href="product_detail.html">5 Star Direct Cool Single Door
                          Refrigerator</a> </div>
                      <div class="brand">Organtic</div>
                      <div class="star-rating">
                        <span style="width:60%">Rated <strong class="rating">3.00</strong> out of 5</span>
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
              ...
              <div class="item item-carousel">
                <div class="item-inner">
                  <div class="item-img">
                    <div class="item-img-info"> <a class="product-image" href="product_detail.html"> <img alt=""
                          src="{{asset('assets\products-images\product12.jpg')}}"> </a>
                      <div class="box-hover">
                        <ul class="add-to-links">
                          <li><a class="link-quickview" href="quick_view.html"></a> </li>
                          <li><a class="link-wishlist" href="wishlist.html"></a> </li>
                ...
                <div class="item-inner">
                  ...
                  <div class="item-info">
                    <div class="info-inner">
                      ...
                      <div class="item-content">
                        <div class="item-price">
                          <div class="price-box"> <span class="regular-price"> <span class="price">AED88.00</span>
                            </span> </div>
                        </div>
                        <div class="count-number">
                          <form id='myform' method='POST' class='quantity' action='#'>
    ...
    <div class="container">
      <div class="wide-banner">
        <div class="row">
          <div class="figure banner-with-effects effect-sadie1 banner-width  with-button"><img src="{{asset('assets\images\watch.jpg')}}"
              alt="">
                ...
                <div class="slider-items slider-width-col4 products-grid block-content">
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html">Anti Glare
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html"> Stovekraft
                          ...
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price">AED 325.00</span>
                                </span> </div>
                            </div>
                            <div class="count-number">
                              <form id='myform' method='POST' class='quantity' action='#'>
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html"> Home
                          ...
                          <div class="item-content">
                            ...
                            <div class="item-price">
                              <div class="price-box"> <span class="regular-price"> <span class="price">AED 245.00</span>
                                </span> </div>
                            </div>
                            <div class="count-number">
                              <form id='myform' method='POST' class='quantity' action='#'>
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html"> Fitness
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html">Mixer Grinder
                              with 3 Stainless Steel Jar</a> </div>
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html">5 Star Direct
                              Cool Single Door Refrigerator</a> </div>
                  ...
                  <div class="item">
                    <div class="item-inner">
                      ...
                      <div class="item-info">
                        <div class="info-inner">
                          <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html">Direct
        ...
        <div class="row">
          <div class="col-12 col-lg-4 col-md-6">
            <div class="position-relative">
              <!-- Background -->
              <img class="img-fluid hover-zoom" src="{{asset('assets/images/01.jpg')}}" alt="">
              <!-- Body -->
              <div class="banner-text">
                <h6 class="text-white">Digital World</h6>
                <!-- Heading -->
                <h3 class="text-white">Exchange <br>
                  Deals</h3>
          ...
          <div class="col-12 col-lg-4 col-md-6 mt-5 mt-md-0">
            <div class="position-relative rounded overflow-hidden">
              <!-- Background -->
              <img class="img-fluid hover-zoom" src="{{asset('assets/images/02.jpg')}}" alt="">
              <!-- Body -->
              <div class="banner-text">
                <h6 class="text-white">Todays Deals</h6>
                <!-- Heading -->
                <h3 class="text-white">Appliances <br>
                  Special</h3>
                <!-- Link --> <a class="more-link text-dark" href="#">Shop Now </a>
              </div>
            </div>
          ...
          <div class="col-12 col-lg-4 col-md-12 mt-5 mt-lg-0 d-md-none d-lg-block">
            <div class="position-relative rounded overflow-hidden">
              <!-- Background -->
              <img class="img-fluid hover-zoom" src="{{asset('assets/images/03.jpg')}}" alt="">
              <!-- Body -->
              <div class="banner-text">
