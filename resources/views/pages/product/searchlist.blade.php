                            ...
                            <div class="category-products">
                                <ol class="products-list" id="products-list">
                                    @foreach ($datas as $data)
                                        <li
                                            class="item @if ($loop->iteration == 1) first @elseif ($loop->iteration % 2 == 0) even @elseif ($loop->iteration % 1 == 0) odd @endif">
                                            <div class="product-image"> <a href="product_detail.html"
                                                    title="{{ $data->product_name }}"> <img class="small-image"
                                                        src="{{ $data->productimage->image_url }}"
                                                        alt="{{ $data->product_name }}"> </a>

                                            </div>
                                            <div class="product-shop">
                                                <h2 class="product-name"><a href="product_detail.html"
                                                        title="{{ $data->product_name }}">{{ $data->product_name }}</a></h2>
                                                <div class="ratings">
                                                ...
                                                <div class="desc std">
                                                    <p>{{ $data->description }} <a class="link-learn" title=""
                                                            href="product_detail.html">Learn More</a> </p>
                                                </div>
                                                <div class="price-box">
                                                    <p class="old-price"> <span class="price-label"></span> <span
                                                            class="price"> AED {{ $data->product_price }} </span> </p>
                                                    <p class="special-price"> <span class="price-label"></span> <span
                                                            class="price"> AED {{ $data->discounted_price }} </span> </p>
                                                </div>
                                                <div class="actions">
                                                    ...
                                                    <span class="add-to-links"> <a title="Add to Wishlist"
                                                            class="button link-wishlist" href="wishlist.html"></a>
                                            ...
                                            <div class="item-inner">
                                                <div class="item-img">
                                                    <div class="item-img-info"> <a class="product-image"
                                                            title="{{ $item->product_name }}" href="product_detail.html">
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        <div class="item-title"> <a title="{{ $item->product_name }}"
                                                                href="product_detail.html">{{ $item->product_name }}</a>
                                                        </div>
