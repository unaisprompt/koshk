                                        ...
                                        <div class="col-md-4">
                                            <div
                                                ...
                                                <div class="product-shop">
                                                    <h2 class="product-name" style="height:62px;overflow:hidden"><a
                                                            href="{{ url('product-detail?id=' . $product->id) }}"
                                                    ...
                                                    <div class="price-box">
                                                        <p class="old-price"> <span class="price-label"></span> <span
                                                                class="price"> AED {{ $product->product_price }} </span>
                                                        </p>
                                                        <p class="special-price"> <span class="price-label"></span> <span
                                                                class="price"> AED {{ $product->discounted_price }}
                                                            </span> </p>
                                                    </div>
                                ...
                                <fieldset class="filter-price">
                                    ...
                                    <div class="price-field">
                                        <input type="range" min="0" max="{{ $data->max_price }}"
                                            value="0" id="lower" onchange="filter()">
                                        <input type="range" min="0" max="{{ $data->max_price }}"
